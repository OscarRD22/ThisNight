...
class ThisWeekPartys extends StatelessWidget {
  const ThisWeekPartys({super.key});
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: db.collection('flyers_week').orderBy('order').snapshots(),
...
class SliderNextPartys extends StatelessWidget {
  const SliderNextPartys({super.key});
  @override
  Widget build(BuildContext context) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: db.collection('flyers_next').orderBy('order').snapshots(),
              builder: (context, snap) {
                if (snap.hasError) {
                  return const Center(
                      child: Text('Error cargando',
    ...
    return SizedBox(
      ...
      child: Column(
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
              stream: db.collection('aftermovies').orderBy('order').snapshots(),
              builder: (context, snap) {
                if (snap.hasError) {
                  return const Center(
                      child: Text('Error cargando',
