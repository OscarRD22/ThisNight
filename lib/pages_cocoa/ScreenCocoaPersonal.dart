...
class ScreenCocoaPersonal extends StatefulWidget {
  const ScreenCocoaPersonal({super.key});

  @override
  State<ScreenCocoaPersonal> createState() => _ScreenCocoaPersonalState();
}

class _ScreenCocoaPersonalState extends State<ScreenCocoaPersonal> {
