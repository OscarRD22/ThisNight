...
class ScreenClassicDayImages extends StatefulWidget {
  final String eventName;
  final String eventTheme;
  final String imagesPath; // p.ej. flyers/Halloween CLASSIC

  const ScreenClassicDayImages({
    super.key,
  ...
  @override
  State<ScreenClassicDayImages> createState() => _ScreenClassicDayImagesState();
}

class _ScreenClassicDayImagesState extends State<ScreenClassicDayImages> {
  int rows = 2;
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(child: _galleryImages(context)),
        ],
      ),
    );
  }
              ...
              itemBuilder: (context, index) {
                ...
                return GestureDetector(
                  onTap: () {
                    Navigator.pushNamed(
                      context,
                      "classic-image-detail",
                      arguments: {'id': m.id, 'url': m.url},
                    );
                  },
                  child: Hero(
                    tag: m.id,
