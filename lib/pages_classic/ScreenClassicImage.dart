  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        stream: dbClassic.collection('gallery_classic_events').orderBy('order').snapshots(),
          ...
          return ListView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              final imagesPath = (((data['imagesPath'] as String?) ?? '')
                  ...
                  : 'gallery_classic_events/${doc.id}/images';
              ...
              return InkWell(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => ScreenClassicDayImages(
                        eventName: name,
                        eventTheme: theme,
