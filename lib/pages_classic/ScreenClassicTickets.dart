...
class ScreenClassicTickets extends StatefulWidget {
  const ScreenClassicTickets({super.key});
  @override
  State<ScreenClassicTickets> createState() => _ScreenClassicTicketsState();
}

class _ScreenClassicTicketsState extends State<ScreenClassicTickets> {
  static final Uri _eventsUri =
      Uri.parse('https://www.fourvenues.com/es/classic-mataro/events');
